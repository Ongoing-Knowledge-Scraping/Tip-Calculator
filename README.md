...
![Tip Calculator Example](<https://github.com/Ongoing-Knowledge-Scraping/Band-Name-Generator/blob/main/Band-Name-Generator.gif> "Running the code")

## View on Replit ##
https://replit.com/@kpatzer/Tip-Calculator
